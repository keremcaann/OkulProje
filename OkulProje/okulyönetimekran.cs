    ...
    public partial class okulyönetimekran : Form
    {
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (sor == DialogResult.Yes)
            {
                ...
                db.SaveChanges();
                MessageBox.Show("Yönetim Kayıdı Silinmiştir", "Sistem Mesajı", MessageBoxButtons.OK, MessageBoxIcon.Information);
                listele();
            }
        }
        ...
        private void btnkaydet_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            MessageBox.Show("Yönetim Kaydı Oluşturulmuştur.", "Sistem Mesajı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
        ...
        private void btnguncelle_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            MessageBox.Show("Yönetim Kayıdı Güncellenmiştir", "Sistem Mesajı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }

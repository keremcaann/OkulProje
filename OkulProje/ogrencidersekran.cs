...
namespace keremodev
{
    public partial class ogrencidersekran : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            db.SaveChanges();
            MessageBox.Show("Öğrenciye Ders Ataması Yapılmıştır.", "Sistem Mesajı", MessageBoxButtons.OK, MessageBoxIcon.Information);
            listele();
        }
        ...
        private void dataGridView1_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (sor == DialogResult.Yes)
            {
                ...
                db.SaveChanges();
                MessageBox.Show("Ders Ve Öğrenci İlişkisini Silmeyi Onaylıyor Musunuz?", "Sistem Mesajı", MessageBoxButtons.OK, MessageBoxIcon.Information);
                listele();
            }
        }
